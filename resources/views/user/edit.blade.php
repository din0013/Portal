...
{{Form::open(['url' => 'user/register', 'method'=>'post'])}}
    ...
    <div class="form-group">
        ...
        {{Form::password('Password', ['class' => 'form-control validate', 'required' => 'required', 'aria-required' => 'true'])}}
    ...
    <div class="form-group">
        ...
        {{Form::password('PasswordConfirm', ['class' => 'form-control validate', 'required' => 'required', 'aria-required' => 'true'])}}
