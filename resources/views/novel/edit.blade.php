...
{{Form::open(['url' => 'novel/register', 'method'=>'post'])}}
    ...
    <div class="form-group">
        ...
        <div class="input-field">
            {{Form::select('Writer[]', $creators, ($results)? $results -> Writer : null, ['multiple' => true, 'class' => 'form-control'])}}
            {{Form::label('Writer', '作者')}}
        </div>

        <div class="input-field">
            {{Form::select('Painter[]', $creators, ($results)? $results -> Painter : null, ['multiple' => true, 'class' => 'form-control'])}}
